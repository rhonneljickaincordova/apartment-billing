 ...
 * Allows uploading, viewing, and managing images/videos for sharing
 * Uses IndexedDB for local file storage (supports larger files without cloud costs)
 */
function MediaGallery({ media = [], onUpdateMedia, onSave }) {
  ...
  return (
    <div className="relative">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
        Upload images and videos to showcase your rooms. Files are stored locally in your browser.
      </p>
      ...
      {media.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 dark:bg-gray-700 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
            Upload images and videos to share with your posts
          </p>
        </div>
      )}
