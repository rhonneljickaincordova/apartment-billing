...
function LoginScreen() {
  const { loginWithFacebook, loginWithGoogle, loading } = useAuth();
  const toast = useToast();
  const [isLoggingIn, setIsLoggingIn] = useState(null); // 'facebook' | 'google' | null
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-white font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-3"
          >
            {isLoggingIn === 'google' ? (
              <>
