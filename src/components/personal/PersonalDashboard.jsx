 ...
 */
function PersonalDashboard({ dashboard, budgets = [], goals = [], onAddTransaction }) {
  const {
    monthlySummary,
    budgetSummary,
    goalsSummary,
    ...
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {budgetSummary.overBudgetCount > 0 && (
                <p className="text-xs text-red-500 mt-2">
                  {budgetSummary.overBudgetCount} budget(s) exceeded
                </p>
              )}
            </div>
          ) : (
      ...
      <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow p-4 md:p-6 text-white">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            <p className="text-white/70 text-sm">Active Budgets</p>
            <p className="text-xl font-bold">{budgetSummary.budgetCount}</p>
          </div>
        </div>
      </div>
    </div>
